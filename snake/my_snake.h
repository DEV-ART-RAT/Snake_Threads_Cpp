...
struct mySnake{
    ...
    void show(){
        ...
        CLEAR;
        ((sizeMax - sizeSnake)>9999)?cout<<COLOR_BOLDWHITE<<"Largo: "<<sizeSnake<<"   Restante: "<<sizeMax - sizeSnake << "     VIDAS :"<<COLOR_BOLDRED<<" \u2665 "<<RESET<<lifes << "   Dinero:"<<COLOR_BOLDYELLOW<<" \u0024 "<<RESET<<coins<<" Puntos:"<<points<<RESET<<endl:
